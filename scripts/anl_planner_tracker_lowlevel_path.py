...
class anl_planner_listener:
    def __init__(self, max_num_vehicles):
        ...
        self.ego_y = 0.0
        self.ego_ldot = 0.0
        self.lane_change_end_x = 0.0
        self.lane_change_end_y = 0.0
    ...
    def lane_change_trajectory_generation(self, x_origin, y_origin, gamma, LaneWidth):
        ...
        lane_change_end_ID = np.where(lane_change_traj_ID > 0.9)[0]
        ...
        self.traj_x = x[1:lane_change_end_ID]
        self.traj_y = y[1:lane_change_end_ID]
        self.traj_yaw = theta[0:lane_change_end_ID-1]
    
    def lane_change_checker(self):
        print(self.traj_lane_cmd)
